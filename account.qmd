...
In order to use the UConn Health HPC system, you must request a **CAM account**. It is referred to as a CAM account because much of the administration of the UConn Health HPC system is handled by the [Center for Cell Analysis and Modeling at UConn Health](https://health.uconn.edu/cell-analysis-modeling/).
