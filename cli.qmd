...
3. Connect with an [SSH client](#ssh-client) (e.g. Terminal or Windows PowerShell) via the host url using the SSH command:`ssh <user>@<host url>`
...
## SSH Keys
All SSH connections made to the UConn Health HPC system require the use of SSH keys for authentication. See the [SSH Keys](keys.qmd) page for more information and for instructions on how to generate and use SSH keys for authentication. 
