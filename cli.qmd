...
1. Ensure that you have setup an [SSH key](ssh-keys.qmd) for authentication.
...
#### Requirements
- Valid [CAM password](account.qmd) or [SSH key](ssh-keys.qmd)
