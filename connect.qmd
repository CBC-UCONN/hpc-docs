...
While connected to most networks at the UConn Health or if you connect to the [CAM virtual private network](connect.qmd#sec-vpn), the cluster can be accessed through this host url: 
