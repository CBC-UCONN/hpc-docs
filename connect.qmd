...
# [1) Web Access through Open OnDemand](ondemand.qmd)
Open OnDemand is a web-based portal that provides users with access to Mantis and the HPC filesystem. It allows users to run jobs, manage files, open a terminal, and access applications through a user-friendly interface.
...
If you see files named `id_ed25519.pub` and `id_ed25519`, you already have an SSH key pair and can skip ahead to the [Copy to Mantis](#copy-public-ssh-key-to-mantis) section. If you do not see these files or get an error message, you will need to create a new SSH key pair.
...
=======
# [2) Command Line Interface](cli.qmd)
User can connect to the HPC system through a Command Line Interface (CLI) using a terminal. This approach allows for more advanced usage and greater control, but is more complex with a steeper learning curve.
>>>>>>> kerry-dev
