...
- `login.hpc.cam.uchc.edu`
  ...
  - The host will drop you onto one of 7 login nodes: `mantis-sub-[1-7]`
- `mantis-submit.cam.uchc.edu`
  - This host is available when connected to the [CAM VPN](#cam-vpn). 
  - Accepts CAM username/password as well as ssh key authentication. 
  - This host will drop you onto one of 4 login nodes: `mantis-sub-[1-4]`

When connected to the CAM VPN, you can also log in directly to one of the 7 login nodes with `ssh <username>@mantis-sub-[1-7].cam.uchc.edu`. This is sometimes worth trying if the load balancing hosts are not responding. 
