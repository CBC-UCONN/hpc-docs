...
## External Host URL
The cluster can also be accessed through `login.hpc.cam.uchc.edu` from any network (on/off campus, with/without VPN) but requires that you [setup an ssh key](connect.qmd#sec-ssh-keys). 
