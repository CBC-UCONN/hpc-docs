...
If you see files named `id_ed25519.pub` and `id_ed25519`, you already have an SSH key pair and can skip ahead to step 2, [Copy to UCHC HPC system](#copy-public-ssh-key-to-the-uchc-hpc-system) section. If you do not see these files or get an error message, you will need to create a new SSH key pair.
