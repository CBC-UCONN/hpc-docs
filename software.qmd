...
### Environment Modules
The integrated terminal in VSCode will not initialize environment modules by default. To load environment modules, you can either run `source /etc/profile` in the integrated terminal or add it to you your `~/.bashrc` file.
