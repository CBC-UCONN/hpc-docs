...
## Partitions
There are several partitions within the cluster which are groups of nodes with different capabilities. 

### general
This partition contains nodes suitable for most tasks. These nodes have TODO: how many cpus and how much memory. 

### himem
This parition contains nodes suitable for jobs that have large memory requirements. These nodes have TODO: how many cpus and how much memory. 
