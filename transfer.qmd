...
There is an additional host that can be used to transfer data without an SSH key. This host is only accessible through the CAM VPN or the UConnHealth-SECURE WiFi <!-- or UCHC ethernet ?-->. This host requires your CAM password for authentication if you have not setup an SSH key.
